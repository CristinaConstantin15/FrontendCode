hrApp.controller('EmployeeAddController', ['$scope', '$http', '$location', 'CommonResourcesFactory', 'DepartmentService', 'JobsService', 'ManagerService',
    function($scope, $http, $location, CommonResourcesFactory, DepartmentService, JobsService, ManagerService){
        $scope.employee = {};
